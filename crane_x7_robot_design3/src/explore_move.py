...
def main():
    ...
    target_pose.position.x = 0.234301909126
    target_pose.position.y = -0.000252058803213
    target_pose.position.z =  0.276987588729
    q = quaternion_from_euler(-3.14, 0.0, -3.14/2.0)  # 上方から掴みに行く場合
    target_pose.orientation.x =0.706657044748
    target_pose.orientation.y = 0.707063706928
    target_pose.orientation.z =-0.0155607723182
    target_pose.orientation.w = 0.0213212996373
